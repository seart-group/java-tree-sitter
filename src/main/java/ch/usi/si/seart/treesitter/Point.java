 ...
 * represent more human-friendly positions of {@link Tree} nodes within
 * source code. Although {@link Node} positions within files should never
...
public class Point implements Comparable<Point> {
     ...
     * Points are compared by their row values first, and if those
     * are equal they are then compared by their column values.
     *
    ...
    /**
     * Subtracts another point from this point, resulting
     * in a new point with coordinates equal to the difference
