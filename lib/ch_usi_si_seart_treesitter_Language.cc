...
JNIEXPORT jlong JNICALL Java_ch_usi_si_seart_treesitter_Language_clojure(JNIEnv* env, jclass self) {
...
JNIEXPORT jlong JNICALL Java_ch_usi_si_seart_treesitter_Language_cMake(JNIEnv* env, jclass self) {
...
JNIEXPORT jlong JNICALL Java_ch_usi_si_seart_treesitter_Language_elixir(JNIEnv* env, jclass self) {
